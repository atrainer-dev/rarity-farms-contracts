...
contract rarity_attributes {
  ...
  function setAttributes(
    ...
    _attr.strength = _strength;
    _attr.dexterity = _dexterity;
    _attr.constitution = _constitution;
    _attr.intelligence = _intelligence;
    _attr.wisdom = _wisdom;
    _attr.charisma = _charisma;
    return true;
  }
*/
  ...
  function point_buy(
    ...
    require(
      calculate_point_buy(_str, _dex, _const, _int, _wis, _cha) == POINT_BUY
    );
